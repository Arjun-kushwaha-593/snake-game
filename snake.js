...
function main(ctime){
    ...
    // console.log("ctime")    
    if((ctime - lastPaintTime)/1000 < 1/speed){//lastPaintTime mense: screen paint last time 
        return;
    }
    lastPaintTime = ctime;
    gameEngine();
...
function  gameEngine(){
    ...
    //if you have eten the food, increment the score and regenerate the food.
    if(snakeArr[0].y === food.y && snakeArr[0].x === food.x){
        ...
        //     highscore.innerHTML = "High Score: " + highscoreBox;
        // }
